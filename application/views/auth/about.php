<section class="ftco-section ftco-no-pt ftco-no-pb ftco-counter img mt-lg-5" id="section-counter">
    <div class="container">
        <div class="row d-flex">
            <div class="col-md-6 d-flex">
                <img class="img d-flex align-self-stretch" src="<?= base_url('assets/index/images/about-pogba.jpg'); ?>" alt="">
            </div>
