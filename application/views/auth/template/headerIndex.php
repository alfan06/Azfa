...
<<<<<<< HEAD
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/index/css/open-iconic-bootstrap.min.css">
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/index/css/animate.css">
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/index/css/magnific-popup.css">

    <link rel="stylesheet" href="<?php echo base_url() ?>assets/index/css/aos.css ">

    <link rel="stylesheet" href="<?php echo base_url() ?>assets/index/css/ionicons.min.css ">

    <link rel="stylesheet" href="<?php echo base_url() ?>assets/index/css/bootstrap-datepicker.css ">
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/index/css/jquery.timepicker.css ">

    
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/index/css/flaticon.css ">
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/index/css/icomoon.css ">
...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href=""><span>Knights</span></a>
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation">
        <span class="oi oi-menu"></span> Menu
      </button>
  ...
  <!-- END nav -->
  <div class="hero-wrap js-fullheight" style="background-image: <?= base_url('images/bg_1.jpg') ?>;" data-stellar-background-ratio="0.5">
