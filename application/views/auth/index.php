                                                                                          ...
                                                                                          <div class="col-md-6 pb-4 pb-lg-0 col-lg-3">
                                                                                                            <div class="text d-flex">
                                                                                                                              <div class="team-logo d-flex">
                                                                                                                                                <div class="img" style="background-image: <?= base_url('assets/index/images/team-1.jpg')?>;"></div>
                                                                                                                                                <div class="img img-2" style="background-image: <?= base_url('assets/index/images/team-2.jpg')?>;"></div>
                                                                                                                              </div>
